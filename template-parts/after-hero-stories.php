...
if( ! class_exists( 'After_Hero_Stories_Section' ) ) {
    class After_Hero_Stories_Section extends Element_Section {
        ...
        public function render() {
            ...
            $content = array(
                sprintf( '<div class="text">%s</div>', 'Look.<br />Listen.<br />Share.' ),
                '',
                '',
                sprintf( '<div class="text">%s</div>%s', 'Share<br />Your<br />Story', get_svg( 'arrow-right' ) ),
            );
            $items = '';
...
new After_Hero_Stories_Section; 