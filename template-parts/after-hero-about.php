...
if( ! class_exists( 'After_Hero_About_Section' ) ) {
    class After_Hero_About_Section extends Element_Section {
        ...
        public function render() {
            ...
            $grid = sprintf( '<div class="column"><div class="photo-grid">%s</div></div>', $items );
