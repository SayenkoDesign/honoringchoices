...
if( ! class_exists( 'Program_Participants_Section' ) ) {
    class Program_Participants_Section extends Element_Section {
        
        public function __construct() {
            parent::__construct();
                        
            $fields = get_field( 'program_participants' );
        ...
        protected function _add_render_attributes() {
            ...
            $this->add_render_attribute(
                'wrapper', 'class', [
                     $this->get_name() . '-program-participants', 'section-logos'
                ]
            ); 
            
            $this->add_render_attribute(
                'wrapper', 'id', [
                     $this->get_name() . '-program-participants'
                ], true
            );              
...
new Program_Participants_Section;
