...
if( ! class_exists( 'Supporters_Section' ) ) {
    class Supporters_Section extends Element_Section {
        
        public function __construct() {
            parent::__construct();
                        
            $fields = get_field( 'supporters' );
        ...
        protected function _add_render_attributes() {
            ...
            $this->add_render_attribute(
                'wrapper', 'class', [
                     $this->get_name() . '-supporters', 'section-logos'
                ]
            );
            
            $this->add_render_attribute(
                'wrapper', 'id', [
                     $this->get_name() . '-supporters'
                ], true
            );               
